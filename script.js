...
function answer() {
  switch (MBTI) {
    case 0:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm INFP- Người hòa giải- phù hợp với các công việc: Dịch vụ cộng đồng và xã hội; Chăm sóc sức khỏe; Kinh doanh, quản lý và bán hàng;...";
    ...
    case 1:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ENFP- Người truyền cảm hứng/ Người dẫn dắt- phù hợp với các công việc: Dịch vụ cộng đồng và xã hội; Giáo dục; Phương tiện – truyền thông;... ";
    ...
    case 10:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ISFP- Người nghệ sĩ- phù hợp với các công việc: Giải trí, nghệ thuật và thiết kế; Kinh doanh, quản lý và bán hàng; Kiến trúc sư, thợ mộc, thợ may, đầu bếp, thợ kim hoàn;...";
    ...
    case 11:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ESFP- Người trình diễn- phù hợp với các công việc: Phương tiện – truyền thông; Giải trí, nghệ thuật và thiết kế; Dịch vụ cộng đồng và xã hội;...";
    ...
    case 100:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm INTP- Nhà tư duy- phù hợp với các công việc: Nhóm ngành công nghệ IT; Kỹ sư kỹ thuật; Kinh doanh và tài chính;...";
    ...
    case 101:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ENTP- Người có tầm nhìn xa- phù hợp với các công việc: Kinh doanh và lãnh đạo; Nghệ thuật và thiết kế; Khoa học và kỹ thuật;...";
    ...
    case 110:
      ...
      document.querySelector("h2").innerHTML =
        "bạn thuộc nhóm ISTP- Nhà cơ học- phù hợp với các công việc: Cảnh sát, lính cứu hỏa, sỹ quan quân đội, hình sự; Kiến trúc sư, thợ mộc, thợ may, đầu bếp, thợ kim hoàn; IT;...";
    ...
    case 111:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ESTP- Người đề xướng- phù hợp với công việc: Khoa học và đời sống; Giáo dục; Kinh doanh, bán hàng và tài chính;...";
    ...
    case 1000:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm INFJ- Người che chở- phù hợp với công việc: Dịch vụ cộng đồng và xã hội; Giáo dục; Dịch vụ chăm sóc cá nhân;...";
    ...
    case 1001:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ENFJ- Người chỉ dạy- phù hợp với công việc: Giáo dục; Kinh doanh, quản lý và bán hàng; Dịch vụ cộng đồng và xã hội;...";
    ...
    case 1010:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ISFJ- Người nuôi dưỡng- phù hợp với công việc: Dịch vụ cộng đồng và xã hội; Chăm sóc sức khỏe; Khoa học và đời sống;...";
    ...
    case 1011:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ESFJ- Người quan tâm- phù hợp với công việc: Dịch vụ cộng đồng và xã hội; Phương tiện – truyền thông; Giáo dục;...";
    ...
    case 1100:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm INTJ- Nhà khoa học- phù hợp với công việc: Toán học; Kinh doanh và tài chính; Kiến trúc và kỹ thuật;...";
    ...
    case 1101:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ENTJ- Nhà điều hành- phù hợp với công việc: Kinh doanh và tài chính; Lãnh đạo và quản lý; Kiến trúc và kỹ thuật;...";
    ...
    case 1110:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ISTJ- Người kiểm duyệt- phù hợp với công việc: Kinh doanh, bán hàng và tài chính; Văn phòng và hành chính; Kiến trúc sư, kỹ thuật viên và kỹ sư kỹ thuật;...";
    ...
    case 1111:
      ...
      document.querySelector("h2").innerHTML =
        "Bạn thuộc nhóm ESTJ- Người giám sát- phù hợp với công việc: Kinh doanh, bán hàng và tài chính; Văn phòng và hành chính; Kiến trúc sư, kỹ thuật viên và kỹ sư kỹ thuật;...";
