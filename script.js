...
function answer() {
  switch (MBTI) {
    case 0:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là INFP: Người hòa giải";
      document.querySelector("p").innerHTML =
    ...
    case 1:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ENFP: Người truyền cảm hứng/ Người dẫn dắt";
      document.querySelector("p").innerHTML = "Họ thường rất tò mò, duy tâm và khá bí ẩn vì họ tìm kiếm ý nghĩa và thực sự quan tâm đến động cơ của người khác, vì vậy họ thấy cuộc sống rất rộng lớn và có nhiều câu đố chưa được giải mã mà trong đó mọi thứ đều liên hệ với nhau.";
      break;
    ...
    case 10:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ISFP: Người nghệ sĩ";
      document.querySelector("p").innerHTML = "Họ thường được liên hệ với tính tự phát và không thể đoán trước nhất trong tất cả các loại tính cách hướng nội, vì vậy nét đặc trưng nổi bật của họ là sự thay đổi.";
      break;
    case 11:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ESFP: Người trình diễn";
      document.querySelector("p").innerHTML = "Họ thích là trung tâm của sự chú ý và cũng thích những điều đơn giản nhất. Sự vui vẻ và bản chất nồng nhiệt của họ thường rất hấp dẫn người khác, vì vậy họ không bao giờ cạn ý tưởng và sự tò mò của họ là vô hạn.";
      break;
    case 100:
    ...
    case 101:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ENTP: Người phát minh";
    ...
    case 110:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ISTP: Nhà cơ học";
      document.querySelector("p").innerHTML = "Nhóm tính cách này sở hữu nhiều đặc điểm thú vị, họ thường suy nghĩ rất hợp lý và logic, nhưng cũng có thể khiến mọi người ngạc nhiên khi đột nhiên trở nên tự phát và nhiệt tình hơn.";
      break;
    case 111:
    ...
    case 1000:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là INFJ: Người che chở";
      document.querySelector("p").innerHTML = "Nhóm tính cách này thường có những quan điểm mạnh mẽ, đặc biệt là khi liên quan đến các vấn đề mà họ cho là thực sự quan trọng trong cuộc sống, vì vậy nếu nhóm INFJ đấu tranh vì điều gì đó, lý do chính là họ tin vào lý tưởng của chính mình.";
      break;
    case 1001:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ENFJ: Người chỉ dạy";
      document.querySelector("p").innerHTML = "Những người thuộc nhóm tính cách này có sức ảnh hưởng lớn bởi vì họ thường rất lôi cuốn và có tài hùng biện. Họ chăm sóc mọi người một cách chân thành, dễ dàng truyền đạt ý tưởng và ý kiến của họ cho mọi người xung quanh.";
      break;
    case 1010:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ISFJ: Người nuôi dưỡng";
      document.querySelector("p").innerHTML = "Đây là nhóm tính cách vị tha nhất, do đó họ thường tìm kiếm con đường sự nghiệp trong lĩnh vực học thuật, y tế, công tác xã hội hoặc tư vấn; họ cũng tỏa sáng ở các vị trí hành chính và văn phòng, hoặc thậm chí trong các lĩnh vực hơi bất ngờ như thiết kế nội thất.";
      break;
    case 1011:
    ...
    case 1100:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là INTJ: Nhà khoa học";
      document.querySelector("p").innerHTML = "Nhóm này thường được xem là rất thông minh và khó hiểu một cách bí ẩn, vì vậy họ thường tỏa ra sự tự tin, dựa trên kho kiến thức rộng lớn của họ bao gồm nhiều lĩnh vực và khía cạnh khác nhau.";
      break;
    case 1101:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ENTJ: Nhà điều hành";
    ...
    case 1110:
      ...
      document.querySelector("h2").innerHTML = "Nhóm tích cách của bạn là ISTJ: Người kiểm duyệt";
      document.querySelector("p").innerHTML = "Đây là nhóm tính cách phổ biến nhất, họ hướng đến chân lý, tôn trọng sự thật và có xu hướng tiếp thu nhiều thông tin và ghi nhớ chúng trong một thời gian dài.";
      break;
    case 1111:
